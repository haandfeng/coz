 ...
 */
 ...
 void init_coz(void) {
   ...
   // delay period, add delay period to the profiler
   size_t warmup_seconds;
   stringstream(getenv_safe("COZ_WARMUP", "0")) >> warmup_seconds;  // 0 = 不做 warmup
   size_t warmup_ns = warmup_seconds * 1000000000ULL;  // 转为纳秒
